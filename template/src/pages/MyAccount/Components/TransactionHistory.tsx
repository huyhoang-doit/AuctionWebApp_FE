    ...
    >
        <div className="myaccount-orders">
            ...
            <div className="rating-flex">
                ...
                <div className="rating-div">
                    <p className="rating-number">{transactionsDashboard.numberTransactionsRequest}</p>
                    <p className="rating-text" >Số phiên đã đăng kí tham gia</p>
                </div>
                <div className="rating-div">
                    <p className="rating-number">{transactionsDashboard.totalJewelryWon}</p>
                    <p className="rating-text" >Số tài sản trúng đấu giá</p>
                </div>
                <div className="rating-div">
                    <p className="rating-number">{formatNumber(transactionsDashboard.totalPriceJewelryWonByUsername)} ₫</p>
