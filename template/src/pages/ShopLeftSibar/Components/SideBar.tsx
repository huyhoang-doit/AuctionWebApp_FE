  ...
  return (
    <div className="col-lg-3 order-2 order-lg-1">
      <div className="umino-sidebar-catagories_area">
          ...
          <div className="sidebar-categories_menu">
            <ul>
              ...
              <li className="has-sub">
                ...
                >Console Tables <i className="ion-chevron-right"></i
                ></a>
                <ul>
              ...
              <li className="has-sub">
                <a href="javascript:void(0)"
                >Furniture <i className="ion-chevron-right"></i
                ></a>
                <ul>
                  <li>
                  ...
                  <li>
                    <a href="javascript:void(0)">Coffee Tables</a>
                  </li>
                  <li>
              ...
              <li className="has-sub">
                <a href="javascript:void(0)"
                >Home Decor <i className="ion-chevron-right"></i
                ></a>
                <ul>
                  <li>
                    <a href="javascript:void(0)">Candleholders</a>
                  </li>
                  <li><a href="javascript:void(0)">Candles</a></li>
                  <li><a href="javascript:void(0)">Clocks</a></li>
                  <li>
                    <a href="javascript:void(0)">Floor Mirrors</a>
                  </li>
                  <li>
              ...
              <li className="has-sub">
                <a href="javascript:void(0)"
                >Kitchen & Dining <i className="ion-chevron-right"></i
                ></a>
                <ul>
                  ...
                  <li>
                    <a href="javascript:void(0)">Cutting Boards</a>
                  </li>
                  <li>
                    <a href="javascript:void(0)">Dinnerware Sets</a>
                  </li>
              ...
              <li className="has-sub">
                <a href="javascript:void(0)"
                >Living Room Sets <i className="ion-chevron-right"></i
                ></a>
                <ul>
                  <li>
                    <a href="javascript:void(0)"
                  ...
                  <li>
                    <a href="javascript:void(0)">Living room storage</a>
                  </li>
                  <li>
                    <a href="javascript:void(0)"
                    >Living room textiles & rugs</a
                    >
                  </li>
                  <li>
                    <a href="javascript:void(0)">Sofas & armchairs</a>
                  </li>
                  <li>
                    <a href="javascript:void(0)"
                    >TV & media furniture</a
                    >
                  </li>
                </ul>
              </li>
        ...
        <div
          className="umino-sidebar_categories umino-list-product_area compare-list-product_area"
        >
          <div className="umino-categories_title">
            <h5>Compare</h5>
          </div>
        ...
        <div
          className="umino-sidebar_categories umino-banner_area sidebar-banner_area"
        >
