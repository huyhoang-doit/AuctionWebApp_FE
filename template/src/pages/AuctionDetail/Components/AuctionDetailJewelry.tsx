        ...
        >
            <div className="product-description">
                <div className="describe-content info-ap">
                    ...
                    <p>Người có tài sản đấu giá: {props.jewelry?.user?.fullName}</p>
                    <p>
                        <strong>1. Tài sản đấu giá, giá khởi điểm, bước giá, tiền mua hồ sơ, tiền đặt trước:</strong>
                    </p>
                    <ul>
                        <li>
                    ...
                    <p></p>
                    <p>
                        <strong>- Giá khởi điểm: {formatNumber(props.auction?.firstPrice)}&nbsp;
                        </strong>
                        <i>(Bằng chữ: {numberToVietnameseText(props.auction?.firstPrice ? props.auction?.firstPrice : 0)}).
                        </i>
                    </p>
                    <p>
                        <strong>- Chất liệu: {props.jewelry?.material}&nbsp;
                        </strong>
                    </p>
                    <p>
                        <strong>- Cân nặng: {props.jewelry?.weight} gram&nbsp;
                        </strong>
                    </p>
                    <p>
                        <strong>- Mô tả: {props.jewelry?.description}&nbsp;
                        </strong>
                    </p>
                    <p>
                        <strong>- Tiền mua hồ sơ tham gia đấu giá</strong> (trên hệ thống đấu giá trực tuyến được coi là “phí đăng ký tham gia đấu giá”)
                        : <strong>{formatNumber(props.auction?.participationFee)} đồng/Hồ sơ&nbsp;
                        </strong>
                        <i>(Bằng chữ: {numberToVietnameseText(props.auction?.participationFee ? props.auction?.participationFee : 0)} trên hồ sơ).
                        </i>
                    </p>
                    <p>
                        <strong>-
                            Tiền đặt trước: {formatNumber(props.auction?.deposit)} đồng&nbsp;
                        </strong><i>(Bằng chữ: {numberToVietnameseText(props.auction?.deposit ? props.auction?.deposit : 0)}).</i></p>
                    <p>
                        <strong>-&nbsp;
                            Bước giá: {formatNumber(props.auction?.priceStep)} đồng/bước giá&nbsp;
                        </strong><i>(Bằng chữ: {numberToVietnameseText(props.auction?.priceStep ? props.auction?.priceStep : 0)} trên bước giá).</i>
                    </p>
                    <p>
                        <strong>2. Điều kiện, cách thức đăng ký,&nbsp;thời gian bán, thu hồ sơ đấu giá và địa điểm xem tài sản đấu giá:
                        </strong>
                    </p>
                    ...
                    <p>&nbsp; &nbsp;&nbsp;<i><strong>- Đăng ký tham gia đấu giá</strong></i>: Từ {props.auction?.startDate && formatDateString(props.auction.startDate)} đến {props.auction?.endDate && formatDateString(props.auction.endDate)} bằng cách sau:</p>
                    ...
                    <p><strong>3.</strong> <strong>Thời gian nộp khoản tiền đặt trước: </strong>Từ ngày&nbsp;{props.auction?.startDate && formatDateString(props.auction.startDate)} đến {props.auction?.endDate && formatDateString(props.auction.endDate)} bằng cách chuyển khoản theo chỉ dẫn sau:</p>
