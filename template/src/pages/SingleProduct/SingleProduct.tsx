                                    ...
                                    <div className="col-lg-6">
                                        <div className="sp-content">
                                            ...
                                            <div className="qty-btn_area">
                                                <ul>
                                                    <li><a className="qty-btn" href="wishlist.html" data-bs-toggle="tooltip" title="Add To Wishlist"><i
                                                        className="ion-android-favorite-outline"></i>Add To Wishlist</a></li>
                                                    <li><a className="qty-btn" href="compare.html" data-bs-toggle="tooltip" title="Compare This Product"><i
                                                        className="ion-ios-shuffle-strong"></i>Add To Compare</a></li>
                                                </ul>
                                            </div>
