...
export const AuctionRegistrationUser: React.FC<AuctionDetailHistoryProps> = ({ usersRegistration, auction }) => {
    return (<div
        id="registration"
        className="tab-pane"
        role="tabpanel"
    >
        <div style={{ display: "flex", justifyContent: "space-between" }}>
            <div>
                ...
                defaultValue={3} className="btn-group ms-1 me-1">
            ...
            <table className="table table-bordered specification-inner_stuff mt-4">
                <thead>
                    <tr>
                        ...
                        <th className="col-2"><b>Họ tên</b></th>
                    </tr>
                </thead><tbody>
                    {
                        React.Children.toArray(usersRegistration.map(
