        ...
        newClient.subscribe("/user/auction", (message) => {
          ...
          if (receivedData.auctionId === auctionId) {
            ...
            getAuctionRegistrationsByAuctionId(receivedData.auctionId)
              .then((data) => {
                const userFound = data.auctionRegistrationsData.some(
                  (registration) =>
                    registration.user?.id === context?.account?.id
                );
                if (!userFound) {
            ...
            <div className="container">
              <div className="breadcrumb-content">
                <ul>
                  ...
                  <li className="active">{t("AuctionBid.Đăng kí đấu giá")}</li>
                </ul>
              </div>
            </div>
          </div>
                      ...
                      <div className="row">
                        ...
                        {isMyBidFirst() && auction?.state !== "FINISHED" && (
                          <span className="fw-bold text-success mt-2">
                            ...
                            <br />
                            {t(
                              "AuctionBid.Vui lòng chờ người khác đặt giá cao hơn để tiếp tục"
                            )}
                            {t("AuctionBid.trả giá.")}
                          </span>
                        )}
                      </div>
                    </div>
