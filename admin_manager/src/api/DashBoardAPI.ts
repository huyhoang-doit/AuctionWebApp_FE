...
export const getDashBoardInformation = async (yearGetRegisterAccount: number, yearGetAuction: number, yearGetRevenue: number,
    ...
    yearGetJewelry: number, monthGetJewelry: number,
    ...
    &yearGetUserJoinAuction=${yearGetUserJoinAuction}&yearGetJewelry=${yearGetJewelry}&monthGetJewelry=${monthGetJewelry}`;
