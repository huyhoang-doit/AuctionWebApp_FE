...
const Index = () => {
  ...
  useEffect(() => {
    getDashBoardInformation().then((response) => {
    ...
    datasets: [
      {
        ...
        borderWidth: 2,
        data: [
          50000000, 20000000, 80000000, 75000000, 56000000, 45670000, 40200000,
          34000000, 26000000, 55000000, 90000000, 60000000,
        ],
      },
    ],
  };
    ...
    <div>
      <section className="main_content dashboard_part">
        <div className="main_content_iner ">
          <div
            className="container-fluid pr_30 body_white_bg"
            style={{ marginTop: "110px" }}
          >
            <div
              className="row justify-content-center"
              style={{ padding: "30px 0px 0px 100px" }}
            >
                      ...
                      <div className="col-12">
                        <div className="quick_activity_wrap">
                          ...
                          <div className="single_quick_activity">
                            ...
                            <h3>
                              <span className="counter">{totalAuctions}</span>{" "}
                            </h3>
                          </div>
                          <div className="single_quick_activity">
                          ...
                          <div className="single_quick_activity">
                            <h4></h4>
                            <h3>
                              Số lượng ...<span className="counter">1000</span>{" "}
                            </h3>
                          </div>
                        </div>
                      </div>
